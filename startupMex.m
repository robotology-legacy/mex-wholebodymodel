%% Execute this script only once to add the required mex-wholeBodyModel folders to your Matlab path.
clear
close all
clc
...
codycoDir       = getenv('CODYCO_SUPERBUILD_ROOT');
mexDir          = [codycoDir, filesep, '/build/install/mex'];
...
if (~savepath([fileDir, filesep, 'pathdef.m']))
    ...
    disp('There was an error generating pathdef.m To proceed please manually add the contents of variables mexDir, mexWbiWrap and mexWbiWrap to your matlab path');
end
