function figureCont = initVisualizer(t,chi,INIT_CONDITIONS)
...
CONFIG                           = INIT_CONDITIONS.CONFIG;
ndof                             = CONFIG.ndof;
initState                        = INIT_CONDITIONS.initState;
...
if CONFIG.visualize_robot_simulator == 1
    ...
    visualizeSimulation_iDyntree(t,chi,CONFIG);
end

%% Forward dynamics results
if CONFIG.visualize_integration_results == 1  || CONFIG.visualize_joints_dynamics == 1 && test == 1
    ...
    for time = 1:length(t)
        ...
        [~,visual]          = forwardDynamics(t(time), chi(time,:)',INIT_CONDITIONS);
