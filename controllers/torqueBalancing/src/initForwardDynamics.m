...
[CONFIG.gains,CONFIG.linearization.KS,CONFIG.linearization.KD]      = gainsTuning(CONFIG.linearization,CONFIG);
% CONFIG.gains                                                      = constrGainsInit(gains,CONFIG.linearization,CONFIG);
end 
