...
%                      controlling constrained floating base robots. The
%                      contact forces are used as a fictitious control
%                      input for stabilizing the 'centroidal momentum'
%                      dynamics. Then, system's 'zero dynamics' is stabilized
%                      by means of a 'postural' task.
%
...
Jc                   = DYNAMICS.Jc;
M                    = DYNAMICS.M;
% decompose mass matrix; Coriolis and gravity terms
m                    = M(1,1);
Mb                   = M(1:6,1:6);
Mbj                  = M(1:6,7:end);
Mj                   = M(7:end,7:end);
