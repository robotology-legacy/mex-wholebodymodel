...
ndof                = CONFIG.ndof;
numConstraints      = length(CONFIG.constraintLinkNames);
...
%% Dynamics
M                   = DYNAMICS.M;
% Compute motor reflected inertia for control
if CONFIG.use_motorReflectedInertia
    M(7:end,7:end)  =  M(7:end,7:end)+ELASTICITY.B_xi;
end
g                   = DYNAMICS.g;
C_nu                = DYNAMICS.C_nu;
