function  JointReferences = interpInverseKin(t,ikinParam)
%INTERPINVERSEKIN interpolates the joint reference trajectories obtained
...
%   JointReferences = INTERPINVERSEKIN(t,ikinParam) performs linear
