function ContFig = visJointDynamics(t,params,qj,qjRef)
%VISJOINTDYNAMICS visualizes the joint space dynamics of the iCub robot
%                 from forward dynamics integration.
%
%   ContFig = VISJOINTDYNAMICS(t,params,qj,qjRef) takes as inputs the
%   integration time t, a structure params which contains all the utility
