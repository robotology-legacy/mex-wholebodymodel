...
% since for now the world reference frame is that of the left foot sole, 
% the x-axis is the vertical axis for the robot. For ease of plotting, 
% handles of x and z data are switched. This can be removed later.
xaxis = 'zdata';
yaxis = 'ydata';
zaxis = 'xdata';
