...
% create the initial condition of the run-time variable "chi" for
% the integration of the forward dynamics ...
chi_init = wbm_iCub.getStateVar();
qT_b_init = chi_init(1,1);
[p_b, R_b] = frame2posRotm(qT_b_init);
