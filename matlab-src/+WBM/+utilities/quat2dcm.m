function dcm = quat2dcm(quat)
    try
        ...
        qt_b_mdl_r = quat(2:end); % vector (imaginary) part

        % Calculate the Direction Cosine Matrix (DCM) by applying the
        % Euler-Rodrigues' rotation formula for efficent computing of the
        ...
        %       * or in Wikipedia: https://en.wikipedia.org/wiki/Euler-Rodrigues_formula.
