...
% ikin_function calculates the inverse kinematics from a desired CoM
...
if (param.demo_left_and_right == 1)
...
desired_x_dx_ddx_CoM = generTraj (param.com_ini(1:3),t,referenceParams,directionOfOscillation,noOscillationTime);

%% desired acceleration and velocity at joints
[dq_inv, ddq_inv, dikin, traj_obt, delta] = ikin_generator (desired_x_dx_ddx_CoM, param);
...
visual_kin_param.dq_inv         = dq_inv;
