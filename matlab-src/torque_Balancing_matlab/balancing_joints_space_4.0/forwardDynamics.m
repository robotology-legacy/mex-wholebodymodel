...
[T_c, dT_c] = centroidalTransf(xcom, x_b, dxcom, dx_b, M);

% conversion of parameters to the new frame of reference
[Mi,c_vi, gi, Jci, dJcDq_i, vi] = centroidalConversion(M, c_v, g, Jc, dJcDq, v, T_c, dT_c);
...
controlParam.M       = Mi;
controlParam.g       = gi;
controlParam.c_v     = c_vi;
controlParam.v       = vi;
controlParam.Jc      = Jci;
controlParam.dJcDq   = dJcDq_i;
