...
#ifndef MODELINITIALIZEURDF_H
#define MODELINITIALIZEURDF_H
...
{
  class ModelInitializeURDF : public ModelComponent
  {
    public:
      static ModelInitializeURDF *getInstance();
