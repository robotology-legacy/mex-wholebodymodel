...
#ifndef MODELINITIALIZE_H
#define MODELINITIALIZE_H
...
{
  class ModelInitialize : public ModelComponent
  {
    public:
      static ModelInitialize *getInstance();
