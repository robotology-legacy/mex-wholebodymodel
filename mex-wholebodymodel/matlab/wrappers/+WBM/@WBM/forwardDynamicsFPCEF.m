...
function dstvChi = forwardDynamicsFPCEF(obj, t, stvChi, fhTrqControl, foot_conf, clnk_conf, fe_c, ac, ac_f)
    % Computes the *forward dynamics* of the *whole body model* of the given
    % floating-base robot with *foot pose corrections* with  *external forces*
    % (*FPCEF*) that are acting on the contact links of the robot -- *experimental*.
    %
    ...
    %
    % See Also:
    %   :meth:`WBM.forwardDynamicsFPC`, :meth:`WBM.forwardDynamicsFPCPL` and
    %   :meth:`WBM.forwardDynamicsHPCEF`.
    %
    % References:
    ...
    dnu = jointAccelerationsFPCEF(obj, foot_conf, clnk_conf, tau, fe_c, ac, ...
