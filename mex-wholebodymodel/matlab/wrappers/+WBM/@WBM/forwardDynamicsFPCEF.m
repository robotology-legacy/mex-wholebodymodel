function dstvChi = forwardDynamicsFPCEF(obj, t, stvChi, fhTrqControl, feet_conf, clink_conf, fe_c, ac, ac_f)
    ...
    dnu = jointAccelerationsFPCEF(obj, feet_conf, clink_conf, tau, fe_c, ac, ...
