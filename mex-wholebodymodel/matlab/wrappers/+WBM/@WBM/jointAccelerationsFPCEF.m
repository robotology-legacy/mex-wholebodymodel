function [ddq_j, fd_prms] = jointAccelerationsFPCEF(obj, feet_conf, clink_conf, tau, fe_c, ac, varargin)
    ...
    [fc_f, tau_gen] = feetContactForcesPC(obj, feet_conf, tau, ac_f, Jc_f, djcdq_f, M, c_qv, dq_j, nu); % with PC
