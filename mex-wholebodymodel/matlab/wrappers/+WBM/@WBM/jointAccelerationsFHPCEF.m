function [ddq_j, fd_prms] = jointAccelerationsFHPCEF(obj, feet_conf, hand_conf, tau, fe_h, ac_h, varargin)
    ...
    switch nargin
        case 13
            ...
            if iscolumn(varargin{1,4})
                ...
                [M, c_qv, Jc_f, djcdq_f, Jc_h, djcdq_h] = fullWholeBodyDynCS(obj, feet_conf, hand_conf, ...
