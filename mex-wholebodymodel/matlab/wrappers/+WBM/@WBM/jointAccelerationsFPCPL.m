...
function [ddq_j, fd_prms] = jointAccelerationsFPCPL(obj, foot_conf, hand_conf, tau, fhTotCWrench, f_cp, varargin)
    ...
    % pose corrections* and additionally *payload forces* (*FPCPL*) that are
    ...
    % dependency of the *payload forces* that are acting on the hands of the
    % robot.
    %
    ...
    %
    %   .. py:method:: jointAccelerationsFPCPL(foot_conf, hand_conf, tau, fhTotCWrench, f_cp[, ac_f], wf_R_b, wf_p_b, q_j, dq_j, v_b, nu)
    %
    ...
    %
    %   - .. py:method:: jointAccelerationsFPCPL(foot_conf, hand_conf, tau, fhTotCWrench, f_cp[, ac_f], Jc_f, djcdq_f, M, c_qv, dq_j, nu)
    %   - .. py:method:: jointAccelerationsFPCPL(foot_conf, hand_conf, tau, fhTotCWrench, f_cp[, ac_f], dq_j, v_b, nu)
    %
    % Arguments:
    ...
    %
    % See Also:
    %   :meth:`WBM.jointAccelerationsFPC`, :meth:`WBM.jointAccelerationsFPCEF`,
