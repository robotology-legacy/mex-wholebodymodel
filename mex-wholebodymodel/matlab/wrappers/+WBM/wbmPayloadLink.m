...
classdef wbmPayloadLink
    ...
    %   lnk_p_cm     (double, vector): :math:`(3 \times 1)` Cartesian position vector
    %                                  relative from the center of mass *cm* of the
    %                                  payload object to the link frame *lnk*. Default
    %                                  position: :math:`[0, 0, 0]^T`.
    ...
    %                                  assigned to any given geometric volume body of
    %                                  the simulation environment (default value: 0).
    ...
    %   I_cm         (double, matrix): :math:`(3 \times 3)` *inertia tensor* of a rigid
    %                                  body or geometric object with the origin of the
    %                                  coordinate system at the center of mass (CoM) of
    %                                  the object body. The matrix is *empty*, if the
    %                                  inertia is undefined.
    % See Also:
