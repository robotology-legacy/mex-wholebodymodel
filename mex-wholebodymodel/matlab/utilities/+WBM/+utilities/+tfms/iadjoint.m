function b_X_a = iadjoint(varargin)
    ...
    switch nargin
        case 2
            ...
            WBM.utilities.chkfun.checkMatCVecDs(a_R_b, a_p_b, 3, 3, 'iadjoint');
        ...
        case 1
            if iscolumn(varargin{1,1})
                ...
                WBM.utilities.chkfun.checkCVecDim(a_p_b, 3, 'iadjoint');
            ...
            elseif ismatrix(varargin{1,1})
                ...
                WBM.utilities.chkfun.checkMatDim(a_R_b, 3, 3, 'iadjoint');
                R_t = a_R_b.';
