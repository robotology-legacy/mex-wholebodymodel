function plotquat(vqT, twait)
    ...
    R = WBM.utilities.tfms.axang2rotm( vertcat(rax_x(1,1), rax_y(1,1), rax_z(1,1), ang_t(1,1)) );
    ...
    if ~verLessThan('matlab', '8.4.0')
        ...
        for i = 2:nRows
            ...
            R = WBM.utilities.tfms.axang2rotm( vertcat(rax_x(i,1), rax_y(i,1), rax_z(i,1), ang_t(i,1)) );
