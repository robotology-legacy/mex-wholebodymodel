function B_inv = eul2angRateTF(eul, sequence)
    WBM.utilities.chkfun.checkCVecDim(eul, 3, 'eul2angRateTF');
    ...
    %  The transformation matrices relating the angular velocity vector w = (w_x, w_y, w_z)^T of the body
    %  to the time derivative of the Euler angle vector Theta, s.t.
    %
